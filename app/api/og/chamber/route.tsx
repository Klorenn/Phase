...
// NFT image position — calibrated visually to fit inside the purple neon frame:
// Centered in screen, slightly above middle. Reference: /collection/[id] CrtCollectionPreview.
const NFT_LEFT   = 505
const NFT_TOP    = 142
const NFT_WIDTH  = 190
const NFT_HEIGHT = 195
